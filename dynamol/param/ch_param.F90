...
!
      logical, save :: ch_param_initialized=.false.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       use ivector
       implicit none
       integer, pointer, dimension(:) :: d, getdpar_ind
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       use ivector
       implicit none
       integer, pointer, dimension(:) :: d, getipar_ind
       character(len=*) :: a1,a2,a3,a4
!
...
!
       integer :: i
       character(len=14), parameter :: whoami = 'PARSE_CH_PARAM'
!
       integer, parameter :: qver=0, qbond=1, qangl=2, qdihe=3, qimpr=4, qnonb=5, qhbon=6, qnbfi=7, qcmap=8
       integer :: which
       logical :: qerror
!
       integer :: ioerr, ierror
       integer :: l=0, oldl=0, newl=0
       character(len=400) :: cmdline
       character(len=400) :: oldcmd, newcmd ! for line continuation
       character(len=8) :: keyword, atom1, atom2, atom3, atom4
       real*8 :: kb, b0, ktheta, theta0, kub, s0, kchi, delta
       integer :: version=-1
       integer :: typeid, idummy, mult
       real*8 :: amass, rmino2, rmino214, eps, eps14, fdummy
...
!
       character(len=14), parameter :: whoami = 'LIST_CH_PARAMS'
       integer :: i
!
!
