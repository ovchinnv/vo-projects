...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      enddo
! print message
      write(msg___,666) whoami, iteration, def; do i_=1,size(msg___);if(msg___(i_)=='')exit;call plainmessage(msg___(i_),4);enddo;msg___=''
...
!ccc pick the set of axis that yields optimal alignment
     ...
     & write(msg___,600) whoami,mestring,i,whoami; do i_=1,size(msg___);if(msg___(i_)=='')exit;call plainmessage(msg___(i_));enddo;msg___=''
...
!
         ...
         elseif (me.eq.where4) then
            ...
            write(msg___,601) whoami,mestring ; do i_=1,size(msg___);if(msg___(i_)=='')exit;call plainmessage(msg___(i_));enddo;msg___=''
