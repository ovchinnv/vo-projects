...
name='diala2' ; #prefix for output files
...
psffile='diala2-nbx2.psf' ;
pdbfile='diala2-0.pdb' ;
# single-replica files to check that the energy scaled properly with duplication
#psffile='diala.psf' ;
#pdbfile='diala.pdb' ;
...
cutoff=22;       # nonbonded cutoff
switchdist=20;   # optional : default is cutoff - 1.5
...
dynamo=1;
dynamoConfig='diala2.smcv';
dynamoLog='diala2.smcv.log';

#struna=1;
#strunaConfig='diala2.smcv';
#strunaLog='diala2.smcv.log';
