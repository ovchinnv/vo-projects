...
write(msg___,*)'ERROR ADDING POSITION_COM_',pos,' CV. NOTHING DONE.';call warning(whoami, msg___(1), 0)
         cv_posi_com_add=.false.
        endif
       else ! found
write(msg___,*)' POSITION_COM_',pos,' CV ALREADY PRESENT. NOTHING DONE.';call warning(whoami, msg___(1), 0)
         cv_posi_com_add=.false.
       endif
...
!
       real*8 :: dummy
!
       integer, allocatable, dimension(:) :: ind1, indf! , indpsf1
...
! variables for cv and derivative calculations
       real*8 :: com(3), f, w, totm1
       real*8 :: A(3,3) ! orthogonal transformation matrix
       real*8 :: dA(3,3) ! derivative of A
       real*8 :: p(3) ! position in the local reference frame
