...
__EXTERNC void RMSBestFitGrad(__CFLOAT *,__CFLOAT *, __CFLOAT *, __CINT, __CFLOAT *, __CFLOAT, __CINT, __CINT, __CFLOAT*);
__EXTERNC void RMSBestFitGradEval(__CFLOAT *,__CFLOAT *, __CFLOAT *, __CINT, __CFLOAT *, __CINT, __CINT, __CFLOAT*, __CFLOAT*);
//com
