...
!real*4 :: x, erfsun_single
!real*8 :: y
!y=x ; erfsun_single=erfsun(y)
!end function erfsun_single
!________________________APPROXIMATIONS____________________________
function erfo7(x)
implicit none
